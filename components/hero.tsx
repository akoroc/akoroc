...
export default function Hero() {
  ...
  const parentMotionProps = reduce
    ? {}
    : ({
        initial: 'hidden',
        animate: 'show',
    ...
    <Section>
      <div className="mx-auto max-w-7xl px-4 md:px-6">
        <div className="grid items-center gap-10 md:grid-cols-2">
          <motion.div {...parentMotionProps} className="space-y-6">
          ...
          <motion.div {...cardMotionProps} className="relative">
